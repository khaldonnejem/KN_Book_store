...
<head>
    ...
    <title> Customer Name & Author Name</title>
    <style>
        .result {
    display: flex;
...
<body style="background-color: #DDD2CE;">
    ...
    <div class="container border border-dark  mt-5 ">
        <div class="d-flex justify-content-between align-items-center">
            <h1> Customer Name & Author Name</h1>
...
$query = 'BEGIN :result := get_customer_info(:customer_id); END;';
...
oci_bind_by_name($stmt, ':customer_id', $truncated_string0);
