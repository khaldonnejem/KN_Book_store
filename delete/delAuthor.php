...
<div class="container  mt-5 ">
    ...
    $sql = 'BEGIN delete_author(:author_id); END;';
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($result) {
            echo "<div class='text-white' style ='background-color:#FF3D41;text-align:center;font-size:25px;'><b>Author deleted successfully</b></div>";
