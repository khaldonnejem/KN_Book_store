...
<div class="container  mt-5 ">
    ...
    $sql = 'BEGIN delete_customer(:customer_id); END;';
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($result) {
            echo "<div class='text-white' style ='background-color:#FF3D41;text-align:center;font-size:25px;'><b>Customer deleted successfully</b></div>";
