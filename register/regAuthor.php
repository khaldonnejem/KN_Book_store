...
<body style="background-color: #DDD2CE;">
        ...
        <form method="POST">
                <table class="table table-bordered" style="background-color:rgb(50,100,150); width:450px ;">
                    <tr>
                        ...
                        <td><input type="text" name="author_id" value="<?php echo @$_POST['author_id']?>" required></td>
                    </tr>
                    <tr>
                        <td><label class="text-white">Author Name</label></td>
                        <td><input type="text" name="author_name"  value="<?php echo @$_POST['author_name']?>" required></td>
                    </tr>
    ...
    $sql = 'BEGIN register_author(:author_id, :author_name); END;';
    ...
    if ($result) {
        echo "<div class='text-white' style ='background-color:#326496;text-align:center;font-size:25px;'><b>New Author created successfully</b></div>";
    } else {
