...
<body style="background-color: #DDD2CE;">
        ...
        <form method="POST">
                <table class="table table-bordered" style="background-color:rgb(50,100,150); width:450px ;">
                    <tr>
                        ...
                        <td><input type="text" name="customer_id" value="<?php echo @$_POST['customer_id']?>" required></td>
                    </tr>
                    <tr>
                        <td><label class="text-white"> First Name</label></td>
                        <td><input type="text" name="first_name"  value="<?php echo @$_POST['first_name']?>" required></td>
                    </tr>
                    <tr>
                        <td><label class="text-white"> Last Name</label></td>
                        <td><input type="text" name="last_name"  value="<?php echo @$_POST['last_name']?>" required></td>
                    </tr>
                    <tr>
    ...
    $sql = 'BEGIN register_customer(:customer_id, :first_name,:last_name,:email); END;';
    ...
    if ($result) {
        echo "<div class='text-white' style ='background-color:#326496;text-align:center;font-size:25px;'><b>New Customer created successfully</b></div>";
    } else {
