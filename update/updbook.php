...
<body style="background-color: #DDD2CE;">
    ...
    $sql = 'BEGIN update_book(:book_id, :title, :isbn13 , :language_id , :num_pages, :publication_date , :publisher_id); END;';
    ...
    if ($result) {
        echo "<div class='text-white' style ='background-color:#326496;text-align:center;font-size:25px;'><b>Book updated successfully</b></div>";
    } else {
